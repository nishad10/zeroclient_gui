...
const image = 'Assets/ZCLogo_R3.png'
                ...
                {this.state.mobile ? (
                  <div className='text-left'>
                    <NavLink to={'/'} className='link'>
                      <img src={icon48} className='img-fluid inherit-size' />
                      <span className='label text-14 align-bottom'>
                        Radium SmartChain
                      </span>
                    </NavLink>
                  </div>
            ...
            <ul className='nav navbar-nav'>
              {settings.current_identity.address != '' ? (
                <li>
                  ...
                  >
                    <span className='glyphicon glyphicon-send'></span> My
                    Profile
                  </NavLink>
                </li>
              ) : null}

              {this.state.webonly ? null : (
                <li>
                  <NavLink
                    to={'/dashboard'}
                    className='link'
              ...
              <li>
                <NavLink
                  to={'/users'}
                  className='link'
                  data-toggle={this.state.mobile ? 'collapse' : null}
                  data-target='.navbar-collapse'
                  activeClassName='active'
                >
              ...
              <li>
                <NavLink
                  ...
                  activeClassName='active'
                >
                  <span className='glyphicon glyphicon-list-alt'></span> Asset
                  Groups
                </NavLink>
              </li>
              <li>
              ...
              <li>
                <NavLink
                  ...
                  activeClassName='active'
                >
                  <span className='glyphicon glyphicon-stats'></span> Signed
                  Messages
                </NavLink>
              </li>
              {false ? (
              ...
              {settings.current_identity.address == '' ? (
                ...
                <li>
                  ...
                  >
                    <span className='glyphicon glyphicon-log-out'></span> Log
                    Out
                  </NavLink>
                </li>
              )}
